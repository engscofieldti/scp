...
public class SistemaBean extends BeanGenerico implements Serializable {
	...
	public void traeUser(){
	   System.out.println("usuario traeUser1 :"+getTxtUsrName());
	 }
	public String traeUser2(){
		   return getTxtUsrName();
		 }
...
//            return;
	...
	public void enviar() {
		  FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO, "Correcto", "Correcto");
			...
			try {
			FacesContext.getCurrentInstance().getExternalContext().redirect("testsub21tablasInvi.jsf");	
		} catch (IOException e) {
		}
			}
